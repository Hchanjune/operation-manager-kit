...
/**
 * Mirrors a real-world @ControllerAdvice (e.g. PlatformExceptionHandler): it converts a domain
 * exception into a normal response, which is exactly the scenario where the original exception
 * never reaches the OMK filter directly.
 */
