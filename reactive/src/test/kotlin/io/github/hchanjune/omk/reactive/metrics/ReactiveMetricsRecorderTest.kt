...
import io.github.hchanjune.omk.reactive.TestSupport.buildTree
import io.github.hchanjune.omk.reactive.TestSupport.context
import io.github.hchanjune.omk.reactive.TestSupport.pushSpan
...
class ReactiveMetricsRecorderTest {
    ...
    fun `records counter for COUNTER span`() {
        ...
        val span = ctx.push(
            ...
            idProvider = io.github.hchanjune.omk.reactive.TestSupport.spanIdProvider
        )
        span.end()
        ctx.pop()
