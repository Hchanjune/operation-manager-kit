...
import io.github.hchanjune.omk.reactive.provider.CustomTelemetryPropagationProvider
import io.github.hchanjune.omk.reactive.provider.OperationCausationIdProvider
import io.github.hchanjune.omk.reactive.provider.OperationManagedContextProvider
import io.github.hchanjune.omk.reactive.provider.OperationSpanIdProvider
import io.github.hchanjune.omk.reactive.provider.OperationTraceIdProvider
...
internal class ProviderConfiguration(
    ...
    fun fallbackIssuerProvider(): IssuerProvider =
