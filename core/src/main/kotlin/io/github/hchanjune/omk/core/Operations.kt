...
import io.github.hchanjune.omk.core.defaults.DefaultOperationExecutorFactory
 ...
 * an operation boundary, producing consistent metadata and [io.github.hchanjune.omk.core.models.OperationResult].
 *
 ...
 *
 * By default, a minimal executor is created via [io.github.hchanjune.omk.core.defaults.DefaultOperationExecutorFactory].
...
object Operations {
     ...
     * @return an [io.github.hchanjune.omk.core.models.OperationResult] containing execution context and produced data
     */
