...
import io.github.hchanjune.operationresult.core.models.metric.MetricTags
import io.github.hchanjune.operationresult.core.models.metric.MetricTiming
...
data class MetricsContext(
     ...
     */
    val tags: MetricTags = MetricTags.Companion.empty(),
     ...
     */
    val timing: MetricTiming = MetricTiming.Companion.started(),
     ...
     */
    val policy: MetricPolicy = MetricPolicy.Companion.defaults()
) {
